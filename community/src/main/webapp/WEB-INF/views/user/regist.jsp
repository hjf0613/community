                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form:form action="/userRegist" method="post" class="login-form"  modelAttribute="user">
			                    	
			                    	<div class="form-group">
			                          <label class="sr-only" for="form-username">用户名</label>
			                          <form:input path="userName" placeholder="用户名" class="form-username form-control" id="form-username" onblur="checkUser()"/>
			                          <form:errors path="userName" />
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">密码</label>
			                        	<form:input path="userPassword" type="password" placeholder="密码" class="form-password form-control" id="form-password"/>
			                        	<form:errors path="userPassword" />
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-email">邮箱</label>
			                        	<form:input path="userEmail" placeholder="邮箱..." class="form-email form-control" id="form-email"/>
			                        	<form:errors path="userEmail" />
			                        </div>
									<div class="form-group">
			                        	<label class="sr-only" for="form-phone">电话号码</label>
			                       		<form:input path="userPhone" placeholder="电话号码..." class="form-phone form-control" id="form-phone"/>
			                       		<form:errors path="userPhone" />
			                        </div>
			                        <form:input path="userState" type="hidden" value="0"/>
