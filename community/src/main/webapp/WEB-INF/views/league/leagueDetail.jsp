				...
				<form method="post" action="/detail">
					...
					<div class="well">
						<div class="tab-pane active in">
							...
							<input type="text" name="leagueCompany" value="${league.leagueCompany}" >
							<label>
								手机：
							</label>
							<input type="text" name="leaguePhone" value="${league.leaguePhone}" >
							<label>
								邮箱：
							</label>
							<input type="text" name="leagueEmail" value="${league.leagueEmail}" >
							<label>
								加盟商状态：
							</label>
