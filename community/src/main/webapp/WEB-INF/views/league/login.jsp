                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to our home</h3>
                            		<span>Enter your phone and password to log on:</span>
                            	 	<span style="color:#934846;font-size:18px;">${error}</span>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="/leagueLogin" method="post" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-leaguename">账号：</label>
			                        	<input type="text" name="leagueName" placeholder="账号" class="form-leaguename form-control" id="form-leaguename">
			                        	
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">密码：</label>
			                        	<input type="password" name="leaguePassword" placeholder="密码" class="form-password form-control" id="form-password">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                        	...
                        	<div class="social-login-buttons">
	                        	<a class="btn btn-link-2" href="#">
	                        		 <i class="fa fa-question-circle fa-lg" aria-hidden="true"></i> 忘记密码
	                        	</a>
	                        	<a class="btn btn-link-2" href="/leagueRegist">
	                        		 <i class="fa fa-rebel" aria-hidden="true"></i> 加盟商注册
	                        	</a>
