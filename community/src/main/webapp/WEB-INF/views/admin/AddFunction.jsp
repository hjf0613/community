...
<html>
	...
	<body class="content1">
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<form method="post" action="/addFunction">
					...
					<div class="well">
						<div class="tab-pane active in">
							...
							<input type="hidden" name="funPid" value="${function.funPid}" />
							<input type="text" name="funPname" value="${function.funPname}"
								readonly="readonly">
							<label>
								功能名称：
							</label>
							...
							<input type="text" name="funUrl" value="${function.funUrl}"
								maxlength="100">
							<label>
								功能状态：
							</label>
							<select name="funState">
								<c:choose>
									<c:when test="${function.funState==\"1\"}">
